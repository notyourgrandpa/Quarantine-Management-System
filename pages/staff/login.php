  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="../../main/index.php">Home <span class="sr-only">(current)</span></a></li>
        ...
        <div class="container" style="margin-top:30px">
          <div class="col-md-4 col-md-offset-4">
            ...
            <div class="panel-heading" style="text-align:center;">
                <img src="../../img/quarantine.png" style="height:110px;"/>
      ...
      <?php
        ...
        { 
            ...
            $user = mysqli_query($con, "SELECT * from tbl_staff where username = '$username' and password = '$password' ");
