  <?php
   ...
   echo  '<header class="header">
            <a href="#" class="logo">
                Quarantine System
                <img src="../../img/quarantine.png" style="height:100px; width:100px;"/>                
            </a>
         ...
         <div id="editProfileModal" class="modal fade">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        if($_SESSION['role'] == "Administrator"){
                            $user = mysqli_query($con,"SELECT * from tbl_users where id = '".$_SESSION['userid']."' ");
                        ...
                        elseif($_SESSION['staff'] == "Staff"){
                            $user = mysqli_query($con,"SELECT * from tbl_staff where id = '".$_SESSION['userid']."' ");
                            while($row = mysqli_fetch_array($user)){
                                echo '
                                    <div class="form-group">
                                        <label>Username:</label>
                            ...
                            $user = mysqli_query($con,"SELECT * from tbl_patients where id = '".$_SESSION['userid']."' ");
                            while($row = mysqli_fetch_array($user)){
                                echo '
                                    <div class="form-group">
                                        <label>Username:</label>
            ...
            if(isset($_POST['btn_saveeditProfile'])){
                ...
                if($_SESSION['role'] == "Administrator"){
                    $updadmin = mysqli_query($con,"UPDATE tbl_users set username = '$username', password = '$password' where id = '".$_SESSION['userid']."' ");
                    if($updadmin == true){
                        header ("location: ".$_SERVER['REQUEST_URI']);
                    }
                }
                elseif($_SESSION['role'] == "Staff"){
                    $updstaff = mysqli_query($con,"UPDATE tbl_staff set username = '$username', password = '$password' where id = '".$_SESSION['userid']."' ");
                    if($updstaff == true){
                        header ("location: ".$_SERVER['REQUEST_URI']);
                    }
                }
